...
export function ReconnectButton(props: { retry: () => void }) {
  return (
    <Button.Root
      type="button"
      id="retry"
      class="mx-3 border-gray-700 border rounded-md p-1 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
      onClick={props.retry}
    >
      <span class="sr-only">Retry connection</span>

      <svg
        class="h-4 w-4 border-none"
        viewBox="0 0 16 16"

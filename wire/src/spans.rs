...
impl SpanEvent {
	...
	pub fn enter_span(at: prost_types::Timestamp, id: tracing_core::span::Id, thread_id: u64) -> Self {
		Self {
	...
	pub fn exit_span(at: prost_types::Timestamp, id: tracing_core::span::Id, thread_id: u64) -> Self {
		Self {

...
Ensure you have [Tauri](https://tauri.app/start/) set up correctly. Then install the Rust instrumentation from crates.io:
...
fn main() {
    ...
    // Tauri v3 does not bundle a webview runtime, pick one (e.g. `tauri-runtime-wry`)

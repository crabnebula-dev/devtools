...
pub mod tauri_server {
    ...
    #[async_trait]
    pub trait Tauri: std::marker::Send + std::marker::Sync + 'static {
    ...
    impl<T> Clone for TauriServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "rs.devtools.tauri.Tauri";
    impl<T> tonic::server::NamedService for TauriServer<T> {

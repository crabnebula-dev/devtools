...
use tauri_devtools_shared::{Tree, LogEntry, SpanEntry};
...
impl Broadcaster {
    pub fn new(trees_in: mpsc::UnboundedReceiver<Tree>, shutdown_in: watch::Receiver<()>, logs_out: broadcast::Sender<Vec<LogEntry>>,
               spans_out: broadcast::Sender<Vec<SpanEntry>>, ) -> Self {
        Self {
            trees_in,
            shutdown_in,
            logs_queue: vec![],

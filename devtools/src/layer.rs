        ...
        S: Subscriber + for<'a> LookupSpan<'a>,
{
    ...
    fn on_new_span(&self, attrs: &tracing_core::span::Attributes<'_>, id: &tracing_core::span::Id, ctx: layer::Context<'_, S>) {
...
impl ActiveSpan {
    ...
    fn new<S>(id: &tracing_core::span::Id, maybe_parent: Option<u64>, attrs: &tracing_core::span::Attributes<'_>, _ctx: &layer::Context<S>) -> Self
        where
